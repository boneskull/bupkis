...
const syncTestConfigs = {
  ...
  'functionschema-to-call-callback-with-value-satisfying-to-invoke-callback-with-value-satisfying-string-regexp-object-3s3p':
    {
      ...
      invalidNegated: {
        property: () =>
          fc.property(
            fc.oneof(fc.string(), fc.object()).chain((expectedValue) =>
              fc.tuple(
                fc.constant((callback: (value: any) => void) => {
  ...
  'functionschema-to-call-nodeback-successfully-satisfying-to-invoke-nodeback-successfully-satisfying-string-regexp-object-3s3p':
    {
      invalid: {
        property: () =>
          fc.property(
  ...
  'functionschema-to-call-nodeback-successfully-to-invoke-nodeback-successfully-unknown-3s3p':
    {
      invalid: {
        generators: [
...
const asyncTestConfigs = {
  ...
  'functionschema-to-eventually-call-nodeback-successfully-satisfying-to-eventually-invoke-nodeback-successfully-satisfying-string-regexp-object-3s3p':
    {
      invalid: {
        asyncProperty: () =>
          fc.asyncProperty(
  ...
  'functionschema-to-eventually-call-nodeback-successfully-to-eventually-invoke-nodeback-successfully-unknown-3s3p':
    {
      invalid: {
        asyncProperty: () =>
          fc.asyncProperty(

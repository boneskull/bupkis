  ...
  'array-to-be-empty-2s2p': {
    invalid: {
      generators: [
        ...
        fc.constantFrom(
          ...extractPhrases(assertions['array-to-be-empty-2s2p']!),
        ),
      ],
    },
    numRuns: 10,
  ...
  'unknown-to-be-_infinity-2s1p': {
    invalid: {
      generators: [
        ...
        fc.constantFrom(
          ...extractPhrases(assertions['unknown-to-be-_infinity-2s1p']!),
        ),
      ],
    },
    valid: {
  ...
  'unknown-to-be-an-async-function-2s1p': {
    invalid: {
      generators: [
        ...
        fc.constantFrom(
          ...extractPhrases(
            assertions['unknown-to-be-an-async-function-2s1p']!,
          ),
        ),
      ],
    },
  ...
  'unknown-to-be-an-error-2s1p': {
    invalid: {
      generators: [
        ...
        fc.constantFrom(
          ...extractPhrases(assertions['unknown-to-be-an-error-2s1p']!),
        ),
      ],
    },
    valid: {
  ...
  'unknown-to-be-nan-2s1p': {
    invalid: {
      generators: [
        ...
        fc.constantFrom(
          ...extractPhrases(assertions['unknown-to-be-nan-2s1p']!),
        ),
      ],
    },
    valid: {

...
{@link schema!WrappedPromiseLikeSchema WrappedPromiseLikeSchema} matches objects that implement the {@link PromiseLike thenable/PromiseLike interface}; i.e. an object having a [then][] method. This is useful when you want to match "thenable" objects that are not necessarily actual [Promise][] instances.
